          ...
          <el-form-item class="input" label="月份" prop="yuefen">
              <el-input v-model="ruleForm.yuefen" 
                placeholder="月份" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="本月课堂数" prop="benyueketangshu">
          <el-input v-model="ruleForm.benyueketangshu" 
              placeholder="本月课堂数" clearable  :readonly="ro.benyueketangshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="本月课堂数" prop="benyueketangshu">
              <el-input v-model="ruleForm.benyueketangshu" 
                placeholder="本月课堂数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="本月请假数" prop="benyueqingjiashu">
          <el-input v-model="ruleForm.benyueqingjiashu" 
              placeholder="本月请假数" clearable  :readonly="ro.benyueqingjiashu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="本月请假数" prop="benyueqingjiashu">
              <el-input v-model="ruleForm.benyueqingjiashu" 
                placeholder="本月请假数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实际上课数" prop="shijishangkeshu">
          <el-input v-model="ruleForm.shijishangkeshu" 
              placeholder="实际上课数" clearable  :readonly="ro.shijishangkeshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实际上课数" prop="shijishangkeshu">
              <el-input v-model="ruleForm.shijishangkeshu" 
                placeholder="实际上课数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
...
export default {
  data() {
	...
	yuefen : false,
	benyueketangshu : false,
	benyueqingjiashu : false,
	shijishangkeshu : false,
	zhaopian : false,
	userid : false,
      },
            ruleForm: {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuefen = true;
            continue;
	            	            ...
	            	            if(o=='benyueketangshu'){
            this.ruleForm.benyueketangshu = obj[o];
	    this.ro.benyueketangshu = true;
            continue;
          }
	            	            if(o=='benyueqingjiashu'){
            this.ruleForm.benyueqingjiashu = obj[o];
	    this.ro.benyueqingjiashu = true;
            continue;
          }
	            	            if(o=='shijishangkeshu'){
            this.ruleForm.shijishangkeshu = obj[o];
	    this.ro.shijishangkeshu = true;
            continue;
          }
	            	            if(o=='zhaopian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `ketangtongji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.ketangtongjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
